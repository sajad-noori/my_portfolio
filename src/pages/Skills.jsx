...
const Skills = () => {
  ...
  return (
    <div
      className={`skills-page-wrapper ${
        theme === "dark" ? "skills-page-dark" : "skills-page-light"
      }`}
    >
      <div
            ...
            <div className="info-grid">
              <div className="info-item">
                ...
                <div className="info-content">
                  ...
                  <p>
                    Creating layouts that work seamlessly across all devices and
                    screen sizes.
                  </p>
                </div>
              </div>
              <div className="info-item">
                ...
                <div className="info-content">
                  ...
                  <p>
                    Improving load times and overall application performance.
                  </p>
                </div>
              </div>
              <div className="info-item">
