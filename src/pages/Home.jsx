...
import { FiGithub, FiLinkedin, FiTwitter, FiArrowRight, FiCode, FiLayers, FiZap, FiPhone, FiMail } from 'react-icons/fi';
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="hero-content">
            ...
            I'm <span className="highlight">Sajad Noori</span>, a dedicated developer passionate about building modern, efficient, and user-friendly web applications. I specialize in React.js and Node.js, turning complex ideas into seamless and interactive digital experiences.    </motion.p>
            ...
            <motion.div variants={itemVariants} className="tech-stack">
              ...
              <div className="tech-tags">
                {['React', 'Node.js', 'Next.js', 'TypeScript', 'Express.js', 'MongoDB', 'MySQL', 'Git', 'JWT', 'Tailwind CSS', 'Bootstrap', 'GitHub'].map((tech) => (
            ...
            <motion.div variants={itemVariants} className="contact-links">
              ...
              <div className="contact-methods">
                ...
                <a href="mailto:sajadnooribayany@gmail.com" className="contact-item">
        ...
        >
          {[
            ...
            },
            {
              ...
              title: 'Modern Stack',
              description: 'Leveraging the latest technologies to build fast, responsive, and scalable applications.'
            },
            {
              icon: <FiZap className="feature-icon" />,
              title: 'Performance',
              description: 'Optimized solutions that load quickly and run smoothly across all devices.'
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
